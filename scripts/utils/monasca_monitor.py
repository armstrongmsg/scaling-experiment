...
class Monasca_Monitor:
    ...
    def first_measurement(self, name, dimensions):
        return [None, None, None] if self.get_measurements(name, dimensions, '2014-01-01T00:00:00Z') is None \
            else self.get_measurements(name, dimensions)[0]

    def last_measurement(self, name, dimensions):
        measurements = self.get_measurements(name, dimensions, '2014-01-01T00:00:00Z') 
